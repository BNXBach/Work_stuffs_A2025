...
\section*{Partie 1}
Ici, on utilise des définitions et aussi la preuve d'une proposition dans la chapitre 4 de la livre de Birge et Louveaux \cite{book} .\\~\\
...
On cite maintenant la propostion et l'épreuve de la livre de Birge et Louveaux \cite{book}:
\begin{equation*}
    WS\leq RP \leq EEV
\end{equation*}
\textbf{PREUVE:}\\
...
Le code Julia pour résoudre le programme est dans le notebook \href{https://github.com/BNXBach/Work_stuffs_A2025/blob/main/TP_IFT/TP1.ipynb}{TP1.ipynb}.
...
Par contre, dans la livre de Birge et Louveaux \cite{book}, ils ont défini $\mathcal{Q}(x)$ la fonction de recours. Pour éviter toute confusion, on a choisi de suivre la livre de référence et de tracer la fonction $\mathcal{Q}(x) = \E_{\xi}[Q(x,\xi)]$.\\~\\
...
On peut vérifier cette solution graphique avec le programme Julia dans le notebook \href{https://github.com/BNXBach/Work_stuffs_A2025/blob/main/TP_IFT/TP1.ipynb}{TP1.ipynb}.
